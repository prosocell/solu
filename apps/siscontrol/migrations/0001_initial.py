    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clacentro', models.CharField(blank=True, max_length=11, null=True)),
                ('nombreplan', models.CharField(blank=True, max_length=45, null=True)),
                ('claveestado', models.CharField(blank=True, max_length=45, null=True)),
                ('clavemuni', models.CharField(blank=True, max_length=50, null=True)),
                ('clavelocal', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('clavprof', models.CharField(blank=True, max_length=5, null=True)),
